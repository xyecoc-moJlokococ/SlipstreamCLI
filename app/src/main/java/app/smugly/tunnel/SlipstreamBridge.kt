...
import app.smugly.platform.NoOpSocketProtector
import app.smugly.platform.SocketProtect
import app.smugly.platform.SocketProtector
...
object SlipstreamBridge {
    ...
    // Live override without rebuild: run-as app.smugly sh -c 'echo N > files/max_data_qps'
