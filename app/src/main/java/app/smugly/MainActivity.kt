...
class MainActivity : android.app.Activity() {
    ...
    private fun buildMainUi(): View {
        ...
        val frame = FrameLayout(this).apply {
            ...
            setBackgroundColor(color(R.color.smugly_bg))
        }
    ...
    private fun topBar(title: String, showAdd: Boolean): LinearLayout =
        LinearLayout(this).apply {
            ...
            addView(TextView(this@MainActivity).apply {
                ...
                setTextColor(color(R.color.smugly_text_primary))
                setSingleLine(true)
                gravity = Gravity.CENTER_VERTICAL
    ...
    private fun addDrawer(frame: FrameLayout, selected: String) {
        ...
        val panel = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
            isClickable = true
            setBackgroundColor(color(R.color.smugly_card))
    ...
    private fun drawerItemBackground(selected: Boolean): GradientDrawable =
        GradientDrawable().apply {
            ...
            setColor(color(if (selected) R.color.smugly_card_soft else R.color.smugly_card))
        }
    ...
    private fun profileRow(profile: ConfigProfile, selected: Boolean): LinearLayout =
        LinearLayout(this).apply {
            ...
            val marker = TextView(this@MainActivity).apply {
                ...
                setTextColor(color(R.color.smugly_accent))
            }
            val textColumn = LinearLayout(this@MainActivity).apply {
                ...
                addView(TextView(this@MainActivity).apply {
                    ...
                    textSize = 13f
                    setTextColor(color(R.color.smugly_text_secondary))
                    setSingleLine(true)
                }, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
            }
    ...
    private fun buildProfileEditorUi(profile: ConfigProfile?, config: Config): View {
        ...
        base64uEncodingCheckbox = CheckBox(this).apply {
            ...
            textSize = 14f
            setTextColor(color(R.color.smugly_text_secondary))
            buttonTintList = ColorStateList.valueOf(color(R.color.smugly_accent))
        }
    ...
    private fun screenRoot(): LinearLayout {
        window.statusBarColor = color(R.color.smugly_bg)
        if (Build.VERSION.SDK_INT >= 26) {
            window.navigationBarColor = color(R.color.smugly_card)
        }
    ...
    private fun connectButtonOverlay(): FrameLayout =
        FrameLayout(this).apply {
            ...
            connectButton = Button(this@MainActivity).apply {
                ...
                textSize = 18f
                typeface = Typeface.DEFAULT_BOLD
                setTextColor(color(R.color.smugly_button_text_primary))
                connectButtonColor = color(R.color.smugly_accent)
            ...
            connectProgress = ProgressBar(this@MainActivity).apply {
                ...
                indeterminateTintList = ColorStateList.valueOf(color(R.color.smugly_button_text_primary))
                visibility = View.GONE
    ...
    private fun addActionsCard(root: LinearLayout) {
        connectProgress = ProgressBar(this).apply {
            id = R.id.connect_progress
            isIndeterminate = true
            indeterminateTintList = ColorStateList.valueOf(color(R.color.smugly_accent))
            visibility = View.GONE
        }
    ...
    private fun labeledField(label: String, field: View): LinearLayout =
        LinearLayout(this).apply {
            ...
            addView(TextView(this@MainActivity).apply {
                ...
                textSize = 12f
                typeface = Typeface.DEFAULT_BOLD
                setTextColor(color(R.color.smugly_text_muted))
            }, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
    ...
    private fun edit(hint: String, type: Int = InputType.TYPE_CLASS_TEXT): EditText =
        EditText(this).apply {
            ...
            textSize = 15f
            setTextColor(color(R.color.smugly_text_primary))
            setHintTextColor(color(R.color.smugly_text_muted))
    ...
    private fun button(text: String, primary: Boolean = false): Button =
        Button(this).apply {
            ...
            textSize = 13f
            typeface = Typeface.DEFAULT_BOLD
            setTextColor(color(if (primary) R.color.smugly_button_text_primary else R.color.smugly_text_primary))
    ...
    private fun iconButton(iconRes: Int, description: String): ImageButton =
        ImageButton(this).apply {
            ...
            imageTintList = ColorStateList.valueOf(color(R.color.smugly_text_secondary))
    ...
    private fun updateConnectButtonColor(running: Boolean) {
        ...
        val accent = color(R.color.smugly_accent)
    ...
    private fun pillBackground(selected: Boolean): GradientDrawable =
        GradientDrawable().apply {
            ...
            if (selected) {
                setColor(color(R.color.smugly_accent))
            } else {
                setColor(Color.TRANSPARENT)
                setStroke(dp(1), color(R.color.smugly_stroke))
            }
        }
        ...
        LinearLayout(this).apply {
            ...
            options.forEachIndexed { index, label ->
                addView(TextView(this@MainActivity).apply {
                    ...
                    setTextColor(color(if (index == 0) R.color.smugly_button_text_primary else R.color.smugly_text_primary))
                    setOnClickListener {
    ...
    private fun LinearLayout.setPillSelectedIndex(index: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            child.setTextColor(color(if (i == index) R.color.smugly_button_text_primary else R.color.smugly_text_primary))
        }
    }
    ...
    private fun persistGlobalSettingsFromEditor() {
        ...
        val settings = GlobalSettings(
            ...
            localSocksUsername = localSocksUsername.text.toString().trim().ifBlank { "smugly" },
    ...
    private fun showCrashReport() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(t(S.COPY_BTN)) { _, _ ->
                val clipboard = getSystemService(ClipboardManager::class.java)
                clipboard.setPrimaryClip(ClipData.newPlainText("Smugly crash report", reportText))
