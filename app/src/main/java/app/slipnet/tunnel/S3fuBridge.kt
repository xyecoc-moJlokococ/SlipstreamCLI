...
object S3fuBridge {
    ...
    fun startClient(
        ...
        AppLog.i(TAG, "start endpoint=$endpoint bucket=$bucket user=$userId socks=$socksListen")
        val code = runCatching {
            nativeStartClient(endpoint, bucket, accessKey, secretKey, region, userId, psk, socksListen, caFile)
        }.getOrElse {
