...
actual object PlatformLog {
    /**
     * Mirror log lines into `smugly-debug.log` so the Diagnostics screen can show them. Driven by
    ...
    private val logFile: File get() = File(AppPaths.filesDir(), "smugly-debug.log")
